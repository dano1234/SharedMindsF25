...
async function createUniverse(universalMotto) {
    ...
    let text = "give me a flat json object with 36 short descriptions of a people with the motto " + universalMotto + " organized into 6 different types of people who might say that.  Please only use the fields description and type.";
